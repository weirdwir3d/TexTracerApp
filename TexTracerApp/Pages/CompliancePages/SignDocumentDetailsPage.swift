...
struct SignDocumentDetailsPage: View {
    ...
    var body: some View {
            ...
            ScrollView {
                ...
                VStack {
                    ...
                    HStack {
                        ...
                        VStack {
                            if let currentTask = signComplianceDataStore.getCurrentTask() {
                                Text("\(currentTask.pdfFileName).pdf")
                            } else {
                                Text("File name not available")
                            }
                            
                            if let filePath = signComplianceDataStore.getCurrentTask()?.filePath {
                                VStack {
                    ...
                    CommentSection().environmentObject(signComplianceDataStore)
        ...
        .onAppear {
            signComplianceDataStore.setCurrentTask(task)
        }
    ...
    private func downloadPDF() {
        guard let currentTask = signComplianceDataStore.getCurrentTask() else {
